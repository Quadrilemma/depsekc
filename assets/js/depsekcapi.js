...
self.onmessage = async function(event) {
    ...
    try {
        ...
        console.log('Worker: Making API call to depsek API with payload:', finalApiPayload);
        ...
        const response = choice.text // depsek's API response text is in choices[0].message.content
